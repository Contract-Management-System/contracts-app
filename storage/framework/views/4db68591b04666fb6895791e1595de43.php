        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="flex gap-5">
                        ...
                        <div>
                            <h3 class="font-semibold text-slate-900 mb-1"><?php echo e($step['title']); ?></h3>
                            <p class="text-sm text-slate-500 leading-relaxed"><?php echo e($step['desc']); ?></p>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="bg-slate-50 border border-slate-200 rounded-xl p-5">
                    <p class="text-2xl font-display font-semibold text-ink-800 mb-2"><?php echo e($stat[0]); ?></p>
                    <p class="text-xs text-slate-500 leading-snug"><?php echo e($stat[1]); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php /**PATH C:\xampp\htdocs\contracts-app\contracts-app\resources\views/pages/home/sections/how-it-works.blade.php ENDPATH**/ ?>