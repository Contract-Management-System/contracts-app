...
<svg class="w-7 h-7 shrink-0" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="28" height="28" rx="7" fill="<?php echo e($light ? '#3d5af9' : '#1e2788'); ?>"/>
    ...
    <circle cx="20" cy="19" r="4" fill="<?php echo e($light ? '#f97316' : '#f97316'); ?>"/>
    <path d="M18.5 19L19.5 20L21.5 18" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

<span class="<?php echo e($light ? 'text-white' : 'text-ink-900'); ?> font-display font-semibold text-lg tracking-tight">
    ContractVault
</span>
<?php /**PATH C:\xampp\htdocs\contracts-app\contracts-app\resources\views/partials/logo.blade.php ENDPATH**/ ?>