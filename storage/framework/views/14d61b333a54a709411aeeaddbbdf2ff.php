<?php $__env->startSection('title', $contract->title); ?>
<?php $__env->startSection('page-title', $contract->title); ?>
<?php $__env->startSection('page-breadcrumb', 'Contract details'); ?>
...
<div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="<?php echo e(Storage::url($contract->file_path)); ?>" target="_blank" class="btn-secondary btn-sm">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('contracts.edit', $contract)); ?>" class="btn-primary btn-sm">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="lg:col-span-2 card p-6 space-y-6">
        <div>
            ...
            <p class="text-sm text-slate-500"><?php echo e($contract->counterparty); ?></p>
            <?php endif; ?>
        </div>
        ...
        <div>
            ...
            <p class="text-sm text-slate-600 leading-relaxed"><?php echo e($contract->description); ?></p>
        </div>
        <?php endif; ?>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100">
            ...
            <?php if($field['value']): ?>
            <div>
                <p class="text-xxs font-semibold uppercase tracking-widest text-slate-400 mb-1"><?php echo e($field['label']); ?></p>
                <p class="text-sm text-slate-700 font-mono"><?php echo e($field['value']); ?></p>
            </div>
            <?php endif; ?>
    ...
    <div class="space-y-4">
        ...
        <div class="card p-5
            <?php echo e($contract->isExpired()       ? 'border-red-200   bg-red-50'   : ''); ?>

            <?php echo e($contract->isExpiringSoon()  ? 'border-amber-200 bg-amber-50' : ''); ?>

        ">
            <p class="text-xxs font-semibold uppercase tracking-widest mb-2
                <?php echo e($contract->isExpired() ? 'text-red-500' : ($contract->isExpiringSoon() ? 'text-amber-600' : 'text-slate-400')); ?>">
                <?php if($contract->isExpired()): ?> Expired
                <?php elseif($contract->isExpiringSoon()): ?> Expiring Soon
                <?php else: ?> Expires
                <?php endif; ?>
            </p>
            <p class="text-2xl font-display font-semibold
                <?php echo e($contract->isExpired() ? 'text-red-700' : ($contract->isExpiringSoon() ? 'text-amber-700' : 'text-slate-900')); ?>">
                <?php echo e($contract->end_date->format('d M Y')); ?>

            </p>
            <p class="text-xs mt-1
                <?php echo e($contract->isExpired() ? 'text-red-500' : 'text-slate-400'); ?>">
        ...
        <div class="card p-5">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(route('contracts.edit', $contract)); ?>" class="nav-item w-full text-xs">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('contracts.index')); ?>" class="nav-item w-full text-xs">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\contracts-app\contracts-app\resources\views/pages/contracts/show.blade.php ENDPATH**/ ?>